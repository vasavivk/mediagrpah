...
def tgInfo(client: Client, msg: Message):
    ...
    c_size = f"{size_in_bytes / (1024 ** 3):.2f}GB" if size_in_bytes >= 1024 ** 3 else f"{size_in_bytes / (1024 ** 2):.2f}MB"
    ...
    try:
        ...
        msg.reply_text(f"MediaInfo of [{fileName}]({checkm}) \nSIZE : **{c_size}MB** generated by @mediainfo_genbot", disable_web_page_preview=False)
